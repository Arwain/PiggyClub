...
public class PiggyGUI implements PropertyChangeListener {
    ...
    private void setup() {
        ...
        panel.add(jlabel2);
        JLabel jlabel3 = new JLabel("Varik Hoang - Zz.Zz.zz.z...");
        jlabel3.setFont(new Font("Verdana", 1, 10));
        panel.add(jlabel3);
        JLabel jlabel4 = new JLabel("Kirtwinder Gulati - 1/2 cup coder, 2 cups baker, 1 tsp vanilla and " +
                "1/2 cup chocolate chips.\n Mix thoroughly to combine, bake at 360 for 21 minutes");
        jlabel4.setFont(new Font("Verdana", 1, 10));
        panel.add(jlabel4);
